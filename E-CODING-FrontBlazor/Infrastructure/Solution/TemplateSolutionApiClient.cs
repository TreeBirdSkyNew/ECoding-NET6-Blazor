    ...
    public class TemplateSolutionApiClient : ApiClientService, ITemplateSolutionApiClient
{
    ...
    public async Task PutTemplateSolution(string clientName, string api, StringContent content)
    {
        var httpResponseMessage = await PutObject<TemplateSolutionVM>(clientName, api, content);
    }
